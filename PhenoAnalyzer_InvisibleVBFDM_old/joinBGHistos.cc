...
int main(int argc, char const *argv[])
{
  ...
  TFile *HistoOutputFile = new TFile("/home/n.cardonac/AnalysisCode/PhenoAnalyzer_InvisibleVBFDM/finalBGHistos.root", "RECREATE");


  TString inputFolder = "/home/n.cardonac/RunPhenoCodes/invisibleDM/";

  vector<TString> folderNames = {"wz",
                                 "zz",
                                 "ww",
                                 "w+jets",
                                 "z+jets",
