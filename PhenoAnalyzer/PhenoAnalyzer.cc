...
{
  ofstream outfile;
  outfile.open("/home/n.cardonac/AnalysisCode_SUSY_VBF_Higgsino/PhenoAnalyzer/counts.csv", ios_base::app); // append instead of overwrite
...
int main(int argc, char *argv[])
{
  ...
  TDirectory *JetsDirectory = HistoOutputFile->mkdir("Jets");
